...
func (a *API) LabelToken(name string) (uint16, error) { return a.ops.GetOrCreateLabel(name) }

// RelTypeToken returns or creates the token for a relationship type name.
func (a *API) RelTypeToken(name string) (uint16, error) { return a.ops.GetOrCreateRelType(name) }

// LookupLabel returns the token for a label name without creating one if absent.
func (a *API) LookupLabel(name string) (uint16, bool) { return a.ops.LookupLabel(name) }

// LookupRelType returns the token for a relationship type name without creating one if absent.
func (a *API) LookupRelType(name string) (uint16, bool) { return a.ops.LookupRelType(name) }
