...
// newTestBadgerStore creates an in-memory BadgerStore for graph-level
// integration tests that previously lived alongside the BadgerStore
...
// still need a quick BadgerStore factory; this is a re-spelling of the
// helper from internal/badgerstore.
