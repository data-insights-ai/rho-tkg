...
//
// The label registry must be wired to the Store before calling this function
// (via SetLabelRegistry).
func MigrateFromBadger(src *BadgerStore, dst *Store, labels *registrypkg.LabelRegistry) error {
