...
#### Transaction isolation — what v4 actually guarantees

`GraphTx` is a **write-through transaction with compensating rollback**, not an isolated one:
